...
D1 = diag(g*1i*[1 1 1 -3]) + diag(k1*[1 1 loss], 1) + diag(k2*[1 1 loss], -1);
D2 = diag(g*1i*[-3 1 -3 1]) + diag([loss loss loss], 1) + diag([loss loss loss], -1);
D3 = diag(g*1i*[1 1 1 -3]) + diag([k2 k2 loss], 1) + diag([k1 k1 loss], -1);
